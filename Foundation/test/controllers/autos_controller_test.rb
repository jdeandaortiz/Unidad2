...
class AutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auto" do
    assert_difference('Auto.count') do
      post autos_url, params: { auto: { anio: @auto.anio, fecha_adquisicion: @auto.fecha_adquisicion, marca: @auto.marca, modelo: @auto.modelo, precio: @auto.precio } }
    end
  ...
  test "should update auto" do
    patch auto_url(@auto), params: { auto: { anio: @auto.anio, fecha_adquisicion: @auto.fecha_adquisicion, marca: @auto.marca, modelo: @auto.modelo, precio: @auto.precio } }
