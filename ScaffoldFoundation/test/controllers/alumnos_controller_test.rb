...
class AlumnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumno" do
    assert_difference('Alumno.count') do
      post alumnos_url, params: { alumno: { anio_ingreso: @alumno.anio_ingreso, carrera: @alumno.carrera, nombre: @alumno.nombre, numero_control: @alumno.numero_control } }
    end
  ...
  test "should update alumno" do
    patch alumno_url(@alumno), params: { alumno: { anio_ingreso: @alumno.anio_ingreso, carrera: @alumno.carrera, nombre: @alumno.nombre, numero_control: @alumno.numero_control } }
